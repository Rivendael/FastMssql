...
async def setup_test_table(test_config: TestConfig):
...
@pytest.mark.asyncio
async def test_insert_operations(setup_test_table, test_config: TestConfig):
    ...
    async with Connection(test_config.connection_string) as conn:
        ...
        affected_count = getattr(results, 'affected', getattr(results, 'rows_affected', 1))
        ...
        """)
        affected_count = getattr(results, 'affected', getattr(results, 'rows_affected', 3))
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_select_operations(setup_test_table, test_config: TestConfig):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_update_operations(setup_test_table, test_config: TestConfig):
    ...
    try:
        async with Connection(test_config.connection_string) as conn:
            ...
            """)
            affected_count = getattr(result, 'affected', getattr(result, 'rows_affected', 1))
            assert affected_count == 1
            ...
            result = await conn.execute("""
                ...
                WHERE department = 'IT'
            """)
            affected_count = getattr(result, 'affected', getattr(result, 'rows_affected', 2))
            ...
            """)
            affected_count = getattr(result, 'affected', getattr(result, 'rows_affected', 3))
            assert affected_count == 3
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_delete_operations(setup_test_table, test_config: TestConfig):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_upsert_operations(setup_test_table, test_config: TestConfig):
    ...
    try:
        async with Connection(test_config.connection_string) as conn:
            ...
            """)
            affected_count = getattr(results, 'affected', getattr(results, 'rows_affected', 2))
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_bulk_operations(setup_test_table, test_config: TestConfig):
    try:
        async with Connection(test_config.connection_string) as conn:
            ...
            affected_count = getattr(result, 'affected', getattr(result, 'rows_affected', 100))
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_async_dml_operations(test_config: TestConfig):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_transaction_rollback(setup_test_table, test_config: TestConfig):
